...
# Generated: Thu Jun 15 15:30:58 2017
##################################################
...
class video_receiver(grc_wxgui.top_block_gui):
    ...
    def __init__(self):
        ...
        self.channel_bw = channel_bw = 5000000
        ...
        self.uhd_usrp_source_0.set_bandwidth(channel_bw, 0)
        ...
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_char*1, '/home/debashri/Documents/GNURadio_Files/video2.avi', False)
    ...
    def set_channel_bw(self, channel_bw):
        ...
        self.uhd_usrp_source_0.set_bandwidth(self.channel_bw, 0)


def main(top_block_cls=video_receiver, options=None):
